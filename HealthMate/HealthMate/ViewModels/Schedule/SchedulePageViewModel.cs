...
{
    private readonly AddScheduleBottomSheetViewModel _addScheduleBottomSheetViewModel;
    ...
    public SchedulePageViewModel(AddScheduleBottomSheetViewModel addScheduleBottomSheetViewModel)
    {
        _addScheduleBottomSheetViewModel = addScheduleBottomSheetViewModel;
    }

    [RelayCommand]
    private async Task CreateSchedule()
    {
        var medicineSchedule = new AddScheduleBottomSheet(_addScheduleBottomSheetViewModel);
        medicineSchedule.Showing += (_, _) => medicineSchedule.Controller.Behavior.DisableShapeAnimations();
        await medicineSchedule.ShowAsync(true);
    }
