...
public partial class IllnessInfoPopupViewModel : BaseViewModel
{
    private readonly HttpService _httpService;
    private readonly PopupService _popupService;

    public IllnessInfoPopupViewModel(NavigationService navigationService,
    ...
    {
        IsLoading = true;
        var illnessInfo = await _httpService.GetDiseaseInfo(PassedDiagnosis.Id, 2001, PassedBodyPart, Services.HttpServices.Symptoms.Gender.Male);
